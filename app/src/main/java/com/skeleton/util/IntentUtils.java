...
public final class IntentUtils {
     ...
     * @param latitude  Latitude
     * @param longitude Longitude
     * @param zoomLevel MainActivity zoom level of 1 shows the whole Earth, centered at the given lat,lng.
     *                  MainActivity zoom level of 2 shows a quarter of the Earth, and so on. The highest zoom level is 23.
